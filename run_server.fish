...
if not test -f "$MAIN_DIR/data/processed/quezon_city.graph"; or not test -f "$MAIN_DIR/data/processed/quezon_city.dhl.index"; or not test -f "$MAIN_DIR/data/processed/quezon_city.hc2l.index"
...
# Deactivate is automatic in fish when script ends
