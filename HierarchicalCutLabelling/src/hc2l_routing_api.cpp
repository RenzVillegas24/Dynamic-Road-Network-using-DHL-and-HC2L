...
void output_json_response(bool success, const string& error_message = "",
    ...
    if (!success) {
        ...
        if (ci != nullptr) {
            ...
            cout << "      \"index_size_bytes\": " << index_size + memory_tracker->get_current_bytes() << "," << endl;
            cout << "      \"index_size_mb\": " << fixed << setprecision(5) << (index_size / (1024.0 * 1024.0)) + memory_tracker->get_current_mb() << "," << endl;
